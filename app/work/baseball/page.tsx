...
export default function BaseballPage() {
  ...
  const team = members.filter((m) => m.team.toLowerCase().includes("baseball") && m.isPublished);
      ...
      <section className="section tight">
        <div className="container">
          <div className="card" style={{ padding: 28 }}>
            ...
            <Link className="btn btn-primary" href="/partner" style={{ width: "fit-content" }}>Bring us a baseball problem</Link>
          </div>
        </div>
      </section>
    </main>
