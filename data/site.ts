...
export const outcomes = [
  ...
  { name: "Seattle Mariners", category: "Sports", logo: "/assets/logos/seattle-mariners.png", approvedForDisplay: true, prestige: true },
  { name: "Miami Dolphins", category: "Sports", logo: "/assets/logos/miami-dolphins.svg", approvedForDisplay: true, prestige: true },
  { name: "OKC Thunder", category: "Sports", logo: "/assets/logos/okc-thunder.png", approvedForDisplay: true, prestige: true },
  { name: "PFF", category: "Sports Analytics", logo: "/assets/logos/pff.png", approvedForDisplay: true },
  // Technology
  { name: "Google", category: "Technology", logo: "/assets/logos/google.svg", approvedForDisplay: true, prestige: true },
  { name: "Amazon", category: "Technology", logo: "/assets/logos/amazon.svg", approvedForDisplay: true, prestige: true },
  { name: "Oracle", category: "Technology", logo: "/assets/logos/oracle.svg", approvedForDisplay: true, prestige: true },
  { name: "IBM", category: "Technology", logo: "/assets/logos/ibm.svg", approvedForDisplay: true, prestige: true },
  { name: "Coinbase", category: "Technology", logo: "/assets/logos/coinbase.svg", approvedForDisplay: true, prestige: true },
  ...
  { name: "Paramount", category: "Media", logo: "/assets/logos/paramount.png", approvedForDisplay: true, prestige: true },
  { name: "Conagra Brands", category: "Consumer Goods", logo: "/assets/logos/conagra-brands.svg", approvedForDisplay: true },
  // Finance / Banking / Investments / Consulting
  { name: "Goldman Sachs", category: "Finance", logo: "/assets/logos/goldman-sachs.svg", approvedForDisplay: true, prestige: true },
  ...
  { name: "PwC", category: "Consulting", logo: "/assets/logos/pwc.svg", approvedForDisplay: true, prestige: true },
  { name: "Deloitte", category: "Consulting", logo: "/assets/logos/deloitte.svg", approvedForDisplay: true, prestige: true },
  { name: "Altman Solon", category: "Consulting", logo: "/assets/logos/altman-solon.png", approvedForDisplay: true },
  { name: "EY-Parthenon", category: "Consulting", logo: "/assets/logos/ey-parthenon.svg", approvedForDisplay: true },
  // Schools (last)
  { name: "UCLA Anderson", category: "Graduate Program", logo: "/assets/logos/ucla-anderson.png", approvedForDisplay: true },
  { name: "MIT", category: "University", logo: "/assets/logos/mit.svg", approvedForDisplay: true, prestige: true },
  { name: "Harvard", category: "University", logo: "/assets/logos/harvard.svg", approvedForDisplay: true, prestige: true },
