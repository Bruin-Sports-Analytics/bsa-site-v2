...
![Figure 1](/assets/journalism/duckworthlewissternmethod/figure-01.jpg)

## How is the Duckworth-Lewis-Stern Method used?

The DLS Method is based around this straightforward equation:

![Figure 2](/assets/journalism/duckworthlewissternmethod/figure-02.png)
...
![Scorecard for the game (Credits: ESPN Cricinfo)](/assets/journalism/duckworthlewissternmethod/figure-03.png)

## How effective is the Duckworth-Lewis-Stern Method?

Looking at the [dataset of over 6000 Twenty-20 matches played between 2003 and 2017](https://www.kaggle.com/imrankhan17/t20matches), we can see that the split between the games won by teams batting first and those won by the team fielding first is pretty even. This holds true even for games which were interrupted due to rain and required the use of the DLS method.

![Figure 4](/assets/journalism/duckworthlewissternmethod/figure-04.jpg)

But when we focus just on the games played in the [Indian Premier League between 2008 and 2018](https://www.kaggle.com/manasgarg/ipl), we see a huge disparity in the split. While the games played under normal conditions are more or less equally distributed in terms of whether teams batting first or second got the spoils, when we look at the matches in which the DLS method came into play, the team fielding first alarmingly won 74% of the time. It is important to note that this is based on a small sample size of merely 19 games, but the fact that this divide is present, does point towards a systemic issue in the DLS method which fails to account for the explosiveness and rapidly fluctuating nature of a T20 game.

![Figure 5](/assets/journalism/duckworthlewissternmethod/figure-05.jpg)
...
![Figure 6](/assets/journalism/duckworthlewissternmethod/figure-06.jpg)
...
![Figure 7](/assets/journalism/duckworthlewissternmethod/figure-07.jpg)
...
![Figure 8](/assets/journalism/duckworthlewissternmethod/figure-08.jpg)
...
Further Reading: Check out this [M.Sc thesis by Harsha Perera](https://www.stat.sfu.ca/content/dam/sfu/stat/alumnitheses/2011/M.Sc%20thesis-%20Gamage%20Harsha%20Perera_FINAL.pdf) focusing on the Duckworth-Lewis Method in T20 Cricket. Keep in mind that this was published in 2011, before Professor Stern became the custodian of the method.

Hopefully I will have updated [my GitHub](https://github.com/Vedant-Sahu?tab=repositories), so that you can check out the analysis that I did and get the code for the plots that I made.
