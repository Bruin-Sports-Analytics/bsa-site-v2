...
![Figure 2](/assets/journalism/kenderby/figure-02.png)
...
![Figure 3](/assets/journalism/kenderby/figure-03.png)

Post position may not be the make-or-break factor for most horses, but there is still considerable angst among owners and trainers going into the randomly drawn selection a few days before the Derby. Generally, the four outside spots (#1, [#2](https://www.bruinsportsanalytics.com/blog/hashtags/2), [#19](https://www.bruinsportsanalytics.com/blog/hashtags/19), and [#20](https://www.bruinsportsanalytics.com/blog/hashtags/20)) are least desired. Those are occupied by Firenze Fire, Free Drop Billy, Noble Indy, and Combatant respectively this year. All with odds of 30-1 or greater.

No horse has ever won from gate [#17](https://www.bruinsportsanalytics.com/blog/hashtags/17). Solomini will occupy that unlucky spot. Gate [#5](https://www.bruinsportsanalytics.com/blog/hashtags/5) was the spot of last year’s winner, Always Dreaming, and narrowly edges out gate [#10](https://www.bruinsportsanalytics.com/blog/hashtags/10) for highest total winning percentage. Audible will start from 5 and My Boy Jack from 10. Justify drew post [#7](https://www.bruinsportsanalytics.com/blog/hashtags/7) and the other serious contenders are sprinkled in from 6-14, so this should be an even race right off the bat.
...
![Figure 4](/assets/journalism/kenderby/figure-04.png)
...
![Figure 5](/assets/journalism/kenderby/figure-05.png)
